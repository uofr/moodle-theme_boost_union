...
if($user){
    ...
    $PAGE->set_url('/theme/boost_union/unenroltestaccount.php', array('id'=>$course->id));
    ...
    if($enrolled){
        ...
        if ($confirm and confirm_sesskey()) {
            ...
            redirect(new moodle_url('/theme/boost_union/unenroltestaccount.php', array('id'=>$course->id,'action'=>1)));
        }
    }else{
