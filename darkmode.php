...
// Set up the page.
$indexurl = new moodle_url('/theme/boost_union/darkmode.php', array('courseid' => $courseid));
$PAGE->set_url($indexurl);
$PAGE->set_pagelayout('report');
$PAGE->set_title(get_string('darkmodepref', 'theme_boost_union'));
...
if (!empty($action)) {
    ...
    switch ($action) {
        case 'auto' :
			...
			echo $OUTPUT->header();
            echo $OUTPUT->notification(get_string('darkmodeautosuccess', 'theme_boost_union'), 'notifysuccess');
            break;
        case 'enable' :
			error_log('darkmode: enable');
			
            echo $OUTPUT->header();
            echo $OUTPUT->notification(get_string('darkmodeenablesuccess', 'theme_boost_union'), 'notifysuccess');
            break;
        case 'disable' :
            ...
            //}
				...
				echo $OUTPUT->header();
                echo $OUTPUT->notification(get_string('darkmodedisablesuccess', 'theme_boost_union'), 'notifysuccess');
...
$renderer = $PAGE->get_renderer('theme_boost_union', 'darkmodeprefs');
